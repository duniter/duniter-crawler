...
function Synchroniser (server, host, port, conf, interactive, slowOption) {
  ...
  this.sync = (to, chunkLen, askedCautious, nopeers, noShufflePeers) => co(function*() {
    ...
    try {
      ...
      const downloader = new P2PDownloader(localNumber, to, rCurrent.hash, shuffledPeers, watcher, logger, hashf, rawer, Peer, dal, slowOption);
...
function P2PDownloader(localNumber, to, toHash, peers, watcher, logger, hashf, rawer, Peer, dal, slowOption) {
